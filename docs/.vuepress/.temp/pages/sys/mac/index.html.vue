<template><div><h1 id="mac" tabindex="-1"><a class="header-anchor" href="#mac" aria-hidden="true">#</a> Mac</h1>
<h2 id="查看远程端口是否开启" tabindex="-1"><a class="header-anchor" href="#查看远程端口是否开启" aria-hidden="true">#</a> 查看远程端口是否开启</h2>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">nc</span> -vz -w <span class="token number">2</span> <span class="token number">152.67</span>.205.241 <span class="token number">6380</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="mac-tree-查看目录结构" tabindex="-1"><a class="header-anchor" href="#mac-tree-查看目录结构" aria-hidden="true">#</a> Mac Tree 查看目录结构</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><details class="custom-container details"><summary>参数说明</summary>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># tree --help</span>
